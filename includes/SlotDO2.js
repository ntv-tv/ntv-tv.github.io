...
function SlotDO2() {
	...
	this.images = [
		//new Array("cherry", "cherry", "cherry", "cherry", "lemon", "plum", "orange", "melon", "spade", "club", "diamond", "heart", "bell", "seven"),
				new Array("cherry", "lemon", "plum", "orange", "melon", "spade", "club", "diamond", "heart", "bell", "seven"),
		new Array("cherry", "lemon", "plum", "orange", "melon", "spade", "club", "diamond", "heart", "bell", "seven"),
		new Array("cherry", "lemon", "plum", "orange", "melon", "spade", "club", "diamond", "heart", "bell", "seven")
	...
	this.lineColors=["#FF0000","#00FF00","#0000FF"];
	this.lineWidths=[5];
	...
	this.combinations = new Array({
		...
		this.imageHeight = 96;
	this.imageWidth = 96;
	this.machineWidth=500;
		this.machineHeight=500;
	this.extraWidth = 150;
	this.payTableImages=["images/payouts1.png","images/payouts2.png"];
